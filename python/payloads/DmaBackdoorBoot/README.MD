...
Now you need to write server configuration into the Micro Backdoor DLL image file using `payload_builder.py` program (where `192.168.2.7` is IP address of the host where server is running):
