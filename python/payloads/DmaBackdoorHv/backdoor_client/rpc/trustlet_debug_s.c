...
extern const MIDL_SERVER_INFO TrustletDebug_ServerInfo;

extern const RPC_DISPATCH_TABLE TrustletDebug_NDR64__v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE TrustletDebug___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x47919643,0xaab8,0x4e4d,{0xbd,0xa7,0x1c,0xb6,0xaf,0xaa,0xc8,0xd8}},{1,0}},
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&TrustletDebug_NDR64__v1_0_DispatchTable,
    0,
    0,
    0,
    &TrustletDebug_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE TrustletDebug_v1_0_s_ifspec = (RPC_IF_HANDLE)& TrustletDebug___RpcServerInterface;
...
static const MIDL_STUB_DESC TrustletDebug_StubDesc = 
    {
    (void *)& TrustletDebug___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& TrustletDebug_ServerInfo,   /* proxy/server info */
    0
    };

static const RPC_DISPATCH_FUNCTION TrustletDebug_NDR64__table[] =
    {
    NdrServerCallNdr64,
    NdrServerCallNdr64,
    0
    };
static const RPC_DISPATCH_TABLE TrustletDebug_NDR64__v1_0_DispatchTable = 
    {
    2,
    (RPC_DISPATCH_FUNCTION*)TrustletDebug_NDR64__table
    };
...
static const SERVER_ROUTINE TrustletDebug_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)Terminate,
    (SERVER_ROUTINE)GetIdentyKey
    };

static const MIDL_SERVER_INFO TrustletDebug_ServerInfo = 
    {
    &TrustletDebug_StubDesc,
    TrustletDebug_ServerRoutineTable,
    0,
    (unsigned short *) TrustletDebug_Ndr64ProcTable,
    0,
